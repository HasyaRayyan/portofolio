...
// Ambil data dari tabel riwayat dan tabel negara
    ...
    <nav class="navbar navbar-expand-lg navbar-dark custom-navbar">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../produk/riwayat.php">History</a>
                </li>
            </ul>
        </div>
        <!-- Profil User Dropdown -->
        <div class="dropdown">
            <a class="nav-link dropdown-toggle text-white fa fa-user" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <?php echo htmlspecialchars($_SESSION['session_username']); ?>
            </a>
            <div class="dropdown-menu dropdown-menu-right " aria-labelledby="userDropdown">
                <a class="dropdown-item " href="../profil/detail.php">Detail Profil</a>
                <div class="dropdown-divider"></div>
                <div class="profile-card">
                    <h5 class="text-center">Logout</h5>
                    <div class="text-center">
                        <a class="btn btn-logout" href="../../login/logout.php">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p>Directorate General for National Export Development</p>
                    <p>Ministry of Trade Republic of Indonesia</p>
                    <p>JL.P.Rohjoyo, Dusun Banaran, Desa Bumiaji, Kec.Bumiaji, Kota Batu, Prov.Jawa Timur, Indonesia</p>
                    <p><a href="mailto:mail@inaexport.id">44INC@gmail.com</a></p>
                    <p>Operational hour: 08:00 - 15:00 WIB</p>
                </div>
                <div class="col-md-4">
                    <h5 class="text-uppercase">ABOUT 44Inc.ID</h5>
                    <p><a href="#">About Us</a></p>
                    <p><a href="#">Contact Us</a></p>
                </div>
                <div class="col-md-4">
                    <h5 class="text-uppercase">OUR SERVICES</h5>
                    <p><a href="#">Trade Event</a></p>
                    <p><a href="#">Training</a></p>
                    <p><a href="#">Market Information</a></p>
                </div>
            </div>
        </div>
        <div>
            <hr class="my-4">
            <p class="copyright">Copyright © 2024 - 2024 44Inc.</p>
        </div>
    </footer>
    <!-- Skrip JavaScript -->
