...
if (isset($_POST['cek_ongkir'])) {
    ...
    $stmt_negara_asal = $koneksi->prepare("SELECT nama_negara FROM negara WHERE id_negara = ?");
    ...
    $stmt_negara_tujuan = $koneksi->prepare("SELECT nama_negara FROM negara WHERE id_negara = ?");
    ...
    $stmt_ongkos = $koneksi->prepare("SELECT ongkos, beacukai FROM ongkir WHERE id_negara_asal = ? AND id_negara_tujuan = ?");
